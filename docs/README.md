...
| SPC-006 | [OIDC authentication wiring (ADR-002 implementation design)](specs/2026-09-08_SPC-006_oidc-authentication-wiring.md) | APPROVED — implementation wave (`feat/oidc-implementation`) |
