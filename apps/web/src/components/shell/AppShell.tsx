...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden bg-bg">
      ...
      {/* SPC-007 v2 (REQ-005.1): anonymous read-only notice + nudge target
          for `localpm:auth-nudge`. Renders NOTHING while loading or
          authenticated — the session for logged-in users lives in the
          sidebar user block. */}
      <AnonymousBanner />
