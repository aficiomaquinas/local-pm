...
export const NAV_ITEMS = [
  ...
  { href: '/history', label: 'History', icon: Clock, chord: 'g h' },
...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      {/* SPC-007 v2 (REQ-005.1): the authenticated session lives in the
          sidebar bottom-left — avatar initial, email, Admin/Log out menu.
          Fork integration into the upstream shell; renders nothing while
          loading or anonymous. The collapsed rail hides it (the popover has
          nowhere to anchor); this mirrors upstream hiding the shortcuts
